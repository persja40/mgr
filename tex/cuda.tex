...
%\item __device__ - funkcja wywoływana z device i wykonywana na device
%\item __global__ funkcja wywoływana z host i wykonywana na device 
\end{itemize}
...
\lstinputlisting[language=C++, firstline=17, lastline=23]{cuda.cpp}

Przydatne bywa także informacja o wymiarach siatki(zbiór bloków) oraz bloku(zbiór wątków).
\lstinputlisting[language=C++, firstline=27, lastline=32]{cuda.cpp}
...
\end{itemize}
\lstinputlisting[language=C++, firstline=35, lastline=59]{cuda.cpp}
...
\lstinputlisting[language=C++, firstline=63, lastline=71]{cuda.cpp}
...
\lstinputlisting[language=C++, firstline=75, lastline=88]{cuda.cpp}
